...
\begin{itemize}
    ...
    \item \textbf{De Predicción Estocástica a Validación Simbólica:} La matriz resultante de la red se transfiere directamente al módulo \texttt{decision_tree_filter.py}, donde es evaluada secuencialmente para corregir saltos melódicos o cromatismos no permitidos.
