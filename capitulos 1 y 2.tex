...
\bibitem{sengar2025} Sengar, S. S., et al., ``Generative Artificial Intelligence: A Systematic Review and Applications,'' \textit{Multimedia Tools and Applications}, 2025.

\bibitem{wei2024} Wei, L., et al., ``From Tools to Creators: A Review on AI Music Generation,'' \textit{Applied Sciences}, 14(16), 2024.


\bibitem{batlle2024} Batlle-Roca, R., et al., ``Transparency in Music-Generative AI: A Systematic Literature Review,'' \textit{Research Square}, 2024.


\bibitem{fernandez2023} G. C. FERNÁNDEZ, ``Inteligencia Artificial Generativa, creando música a ritmo de perceptrón,`` 18 Julio 2023. [En línea]. Disponible
en: https://telefonicatech.com/blog/ai-of-things-vi-inteligencia-artificial-
generativa-generar-musica.

\bibitem{kaliakatsos20} Kaliakatsos-Papakostas, M., Floros, A., \& Vrahatis, M. N. (2020). Artificial intelligence methods for music generation: A review and future perspectives. En
X.-S. Yang (Ed.), Nature-inspired computation and swarm intelligence (pp. 217–
245). Academic Press.

%--- Cpitulo 2 --- %

% --- 2.1 TEORÍA MUSICAL Y ARMONÍA ---
...
\bibitem{baker2007}Barker, A. (2007). The Science of Harmonics in Classical Greece. Cambridge University Press.

\bibitem{christensen2002}Christensen, T. (Ed.). (2002). The Cambridge History of Western Music Theory. Cambridge University Press.

\bibitem{zwicker2013} Zwicker, E., \& Fastl, H. (2013). Psychoacoustics: Facts and models. Springer Science \& Business Media.

\bibitem{iso16:1975} International Organization for Standardization. (1975). Acoustics — Standard tuning frequency (Standard musical pitch) (ISO 16:1975).

\bibitem{benson2006} Benson, D. J. (2006). Music: A mathematical offering. Cambridge University Press.


\bibitem{isacoff2001temperament} Isacoff, S. (2001). Temperament: How music became a battleground for the great minds of Western civilization. Alfred A. Knopf.

\bibitem{agmon1989diatonic}Agmon, E. (1989). A mathematical model of the diatonic system. Journal of Music Theory, 33(1), 1-25.

\bibitem{krumhansl1982spatiotemporal} Krumhansl, C. L., \& Kessler, E. J. (1982). Tracing the dynamic changes in perceived tonal organization in a spatial representation of musical keys. Psychological Review, 89(4), 334–368.

\bibitem{sudnow2001ways} Selfridge-Field, E. (1995). Beyond MIDI: The handbook of musical codes. MIT Press.

\bibitem{riemann1893simplified} Riemann, H. (1893). Simplified harmony or the theory of the tonal functions of chords. Augener

\bibitem{piston1987harmony} Piston, W. (1987). Harmony (5th ed.). W. W. Norton \& Company.


\bibitem{schoenberg1978} Schoenberg, A., \textit{Theory of Harmony}, University of California Press, 1978.

\bibitem{forte1982introduction} Forte, A., \& Gilbert, S. E. (1982). Introduction to Schenkerian analysis. W. W. Norton \& Company.

\bibitem{mazzola2012topos} Mazzola, G. (2012). The topos of music: Geometric logic of concepts, theory, and performance. Birkhäuser.

\bibitem{chew2014mathematical} Chew, E. (2014). Mathematical and computational models of music theory: From de-mystification to de-reconstruction. Springer.

\bibitem{krumhansl1990cognitive} Krumhansl, C. L. (1990). Cognitive foundations of musical pitch. Oxford University Press.

\bibitem{duffin2007how} Duffin, R. W. (2007). How equal temperament ruined harmony (and why you should care). W. W. Norton \& Company.

\bibitem{delamotte1991harmony} De la Motte, D. (1991). The study of harmony: An historical perspective. Stefan de Vaan.

\bibitem{schoenberg1969structural} Schoenberg, A. (1969). Structural functions of harmony. Williams and Norgate.

\bibitem{aldwell2018harmony} Aldwell, E., Schachter, C., \& Cadwallader, A. (2018). Harmony and voice leading (5th ed.). Cengage Learning.

\bibitem{harrison1994harmonic} Harrison, D. (1994). Harmonic function in chromatic music: A renewed dualist theory and an onto-historical account. University of Chicago Press.

\bibitem{rohrmeier2011generative} Rohrmeier, M. (2011). Towards a generative syntax of tonal harmony. Journal of Mathematics and Music, 5(1), 35-53.

\bibitem{schoenberg1983theory} Schoenberg, A. (1983). Theory of harmony (R. E. Carter, Trans.). University of California Press.

\bibitem{levine2011jazz} Levine, M. (1995). The jazz theory book. Sher Music Co.

\bibitem{russell2001lydian} Russell, G. (2001). Lydian chromatic concept of tonal organization. Concept Publishing Company.

\bibitem{terhardt1982pyschoacoustic} Terhardt, E., Stoll, G., \& Seewann, M. (1982). Algorithm for extraction of pitch and pitch salience from complex tonal signals. The Journal of the Acoustical Society of America, 71(3), 679-688.

\bibitem{tymoczko2006geometry} Tymoczko, D. (2006). The geometry of musical chords. Science, 313(5783), 72-74.

\bibitem{schottstaedt1989automatic} Schottstaedt, B. (1989). Automatic counterpoint. In M. Mathews \& J. R. Pierce (Eds.), Current directions in computer music research (pp. 199–214). MIT Press.

\bibitem{westergaard1975introduction} Westergaard, P. (1975). An introduction to tonal theory. W. W. Norton \& Company.

\bibitem{carey1989aspects} Carey, N., \& Clampitt, D. (1989). Aspects of well-formed scales. Music Theory Spectrum, 11(2), 187-206.

\bibitem{pachet1998content} Pachet, F., \& Roy, P. (1998). Automatic harmonization: A survey. First International Conference on Constraints and Art.

\bibitem{brent2011modalogy} Brent, J., \& Barkley, S. (2011). Modalogy: Scales, modes \& chords: The structural relationships of pictorial harmony. Hal Leonard Corporation.

\bibitem{roeder1984geometric} Roeder, J. (1984). A geometric model of voice-leading. Yale University.

\bibitem{tymoczko2006geometry7274} Tymoczko, D. (2006). The geometry of musical chords. Science, 313(5783), 72–74.

\bibitem{callender2008generalized} Callender, C., Quinn, I., \& Tymoczko, D. (2008). Generalized voice-leading spaces. Science, 320(5874), 346–348.

\bibitem{tymoczko2011geometry} Tymoczko, D. (2011). A geometry of music: Harmony and counterpoint in the extended common practice. Oxford University Press.

\bibitem{bent2011modalogy} Brent, J., \& Barkley, S. (2011). Modalogy: Scales, modes \& chords: The structural relationships of pictorial harmony. Hal Leonard Corporation.

\bibitem{tymoczko2008scale} Tymoczko, D. (2008). Scale theory, coherence, and strategies of group formation. Journal of Music Theory, 52(1), 1–49.

\bibitem{cohn1997neo} Cohn, R. (1997). Neo-Riemannian operations, parsimonious trichords, and their "Tonnetz" representations. Journal of Music Theory, 41(1), 1–66.

\bibitem{catanzaro2011topological} Catanzaro, M. J. (2011). Generalized Tonnetze. Journal of Mathematics and Music, 5(2), 117-139.

\bibitem{bergomi2015topological} Bergomi, M. G. (2015). Topological structures in computer-aided music theory and analysis [Doctoral dissertation, Université Pierre et Marie Curie].

\bibitem{hall2008topology} Hall, R. W. (2008). Geometrical music theory. Science, 320(5874), 328–329.

% --- 2.2 Representacion de datos en la IA musical --%

\bibitem{midi1996specification}  MIDI Manufacturers Association. (1996). The complete MIDI 1.0 detailed specification. MIDI Manufacturers Association.

\bibitem{briot2020deep} Briot, J. P., Gaudin, G., \& Hadjeres, G. (2020). Deep learning techniques for music generation. Springer.

\bibitem{dong2018musegan} Dong, H. W., Hsiao, W. Y., Yang, L. C., \& Yang, Y. H. (2018). MuseGAN: Multi-track sequential generative adversarial networks for symbolic music generation and accompaniment. Proceedings of the AAAI Conference on Artificial Intelligence, 32(1).

\bibitem{huang2018music} Huang, C. Z. A., Vaswani, A., Uszkoreit, J., Shazeer, N., Simon, I., Hawthorne, C., ... \& Eck, D. (2018). Music transformer: Generating music with long-term structure. arXiv preprint arXiv:1809.04281.

\bibitem{conklin1995multiple} Conklin, D., \& Witten, I. H. (1995). Multiple viewpoints for music prediction. Journal of New Music Research, 24(1), 51–73.

\bibitem{temperley2004bayesian} Temperley, D. (2004). A Bayesian approach to key-finding. Contemporary Music Review, 23(3-4), 145–158.

\bibitem{shaw2018self} Shaw, P., Uszkoreit, J., \& Vaswani, A. (2018). Self-attention with relative position representations. arXiv preprint arXiv:1803.02155.

\cite{roberts2018hierarchical} Roberts, A., Engel, J., Raffel, C., Hawthorne, C., \& Eck, D. (2018). A hierarchical latent vector model for learning long-term structure in music. Proceedings of the 35th International Conference on Machine Learning.

\bibitem{wiering2009modeling} Wiering, F., Pollastri, E., \& Volk, A. (2009). Modeling musical style using richness of representation. Proceedings of the 10th International Society for Music Information Retrieval Conference.

\bibitem{hadjeres2017deepbach} Hadjeres, G., Pachet, F., \& Nielsen, F. (2017). DeepBach: A steerable model for chorale generation. Proceedings of the 34th International Conference on Machine Learning.

\bibitem{dehaas2013modeling} De Haas, W. B., Magalhães, J. P., \& Wiering, F. (2013). Modeling harmonic similarity using a functional harmonic analysis. Journal of New Music Research, 42(3), 238–255.

\bibitem{collins2014computational} Collins, T., \& Laney, R. (2014). Computer-generated stylistic compositions. Proceedings of the 5th International Conference on Computational Creativity.

\bibitem{christensen2002cambridge} Christensen, T. (Ed.). (2002). The Cambridge history of Western music theory. Cambridge University Press.

\bibitem{pachet2011finite} Pachet, F., Roy, P., \& Barbieri, G. (2011). Finite-order Markov chains with constraints. Proceedings of the 22nd International Joint Conference on Artificial Intelligence.

\bibitem{farbood2012quantifying} Farbood, M. M. (2012). Quantifying musical tension from structural features. Music Perception, 29(4), 387–402.

% -- 2.3 IA para la generación musical -- %

\bibitem{todd1989connectionist} Peter Todd sentó las bases de cómo una red neuronal puede "recordar" el pasado musical para predecir el futuro. Es la cita ideal para justificar por qué las arquitecturas recurrentes son el estándar para datos secuenciales como los tuyos.

\bibitem{goodfellow2016deep} Goodfellow, I., Bengio, Y., \& Courville, A. (2016). Deep learning. MIT Press.

\bibitem{lecun2015deep} LeCun, Y., Bengio, Y., \& Hinton, G. (2015). Deep learning. Nature, 521(7553), 436-444.

\bibitem{rumelhart1986learning} Rumelhart, D. E., Hinton, G. E., \& Williams, R. J. (1986). Learning representations by back-propagating errors. Nature, 323(6088), 533-536.

\bibitem{abadi2016tensorflow} Abadi, M., Barham, P., Chen, J., Chen, Z., Davis, A., Dean, J., ... \& Kudlur, M. (2016). TensorFlow: A system for large-scale machine learning. In 12th USENIX symposium on operating systems design and implementation (OSDI 16) (pp. 265-283).

\bibitem{bengio1994learning} Bengio, Y., Simard, P., \& Frasconi, P. (1994). Learning long-term dependencies with gradient descent is difficult. IEEE transactions on neural networks, 5(2), 157-166.

\bibitem{eck2002finding} Eck, D., \& Schmidhuber, J. (2002). Finding temporal structure in music: Lessons from LSTM. In Proceedings of the 12th IEEE Workshop on Neural Networks for Signal Processing (pp. 447-456).

\bibitem{holtzman2019curious} Holtzman, A., Buys, J., Du, L., Forbes, M., \& Choi, Y. (2019). The curious case of neural text degeneration. arXiv preprint arXiv:1904.09751.

\bibitem{kingma2014adam} Kingma, D. P., \& Ba, J. (2014). Adam: A method for stochastic optimization. arXiv preprint arXiv:1412.6980.

\bibitem{stanley2002evolving} Stanley, K. O., \& Miikkulainen, R. (2002). Evolving neural networks through augmenting topologies. Evolutionary Computation, 10(2), 99-127. https://doi.org/10.1162/106365602320169811

\bibitem{miranda2013evolutionary} Miranda, E. R., \& Biles, J. A. (Eds.). (2013). Evolutionary computer music. Springer Science \& Business Media.

\bibitem{briot2020deep} Briot, J. P., Pachet, F., \& Gp, S. D. (2020). Deep learning for music generation. Springer Nature.

\bibitem{breiman2017classification} Breiman, L., Friedman, J. H., Olshen, R. A., \& Stone, C. J. (2017). Classification and regression trees. Routledge. (Obra original publicada en 1984).

\bibitem{molnar2020interpretable} Molnar, C. (2020). Interpretable machine learning: A guide for making black box models explainable. Independently published.

\bibitem{pachet2011finite} Pachet, F., \& Roy, P. (2011). Markov constraints: Steerable generation of Markov sequences. Constraints, 16(2), 148-172. https://doi.org/10.1007/s10601-010-9101-4

\bibitem{papadopoulos1999ai} Papadopoulos, G., \& Wiggins, G. (1999). AI methods for algorithmic composition: A survey, a critical view and future prospects. AISB International Conference on AI and Musical Creativity.

\bibitem{lerdahl1985generative} Lerdahl, F., \& Jackendoff, R. (1985). A generative theory of tonal music. MIT Press.

\bibitem{fux1965study} Fux, J. J. (1965). The study of counterpoint (Gradus ad Parnassum). (A. Mann, Trans.). W. W. Norton \& Company. (Obra original publicada en 1725).

\bibitem{herremans2017morpheus} Herremans, D., \& Chew, E. (2017). Morpheus: Generating structured music with high-level patterns and constraints. IEEE Transactions on Affective Computing, 10(4), 489-502. https://doi.org/10.1109/TAFFC.2017.2695597

\bibitem{hadjeres2017deepbach} Hadjeres, G., Pachet, F., \& Nielsen, F. (2017). DeepBach: a steerable model for Bach chorales generation. In Proceedings of the 34th International Conference on Machine Learning (ICML) (pp. 1362-1371). PMLR.

\bibitem{garcez2020neurosymbolic} Garcez, A. D., \& Lamb, L. C. (2020). Neurosymbolic AI: The 3rd Wave. arXiv preprint arXiv:2012.05876.

\bibitem{liu2017hierarchical} Liu, H., Simonyan, K., Vinyals, O., Fernando, C., \& Wierstra, D. (2017). Hierarchical representations for efficient architecture search. arXiv preprint arXiv:1711.00436.

\bibitem{holland1992adaptation} Holland, J. H. (1992). Adaptation in natural and artificial systems: an introductory analysis with applications to biology, control, and artificial intelligence. MIT Press. (Obra original publicada en 1975).

\bibitem{stanley2019designing} Stanley, K. O., Clune, J., Lehman, J., \& Miikkulainen, R. (2019). Designing neural networks through neuroevolution. Nature Machine Intelligence, 1(1), 24-35. https://doi.org/10.1038/s42256-018-0006-z

\bibitem{young2015optimizing} Young, S. R., Rose, D. C., Karnowski, T. P., Lim, S. H., \& Patton, R. M. (2015). Optimizing deep learning hyper-parameters through an evolutionary algorithm. In Proceedings of the Workshop on Machine Learning in High-Performance Computing Environments (pp. 1-5).

\bibitem{takagi2001interactive} Takagi, H. (2001). Interactive evolutionary computation: Fusion of the capacities of EC optimization and human evaluation. Proceedings of the IEEE, 89(9), 1274-1296. https://doi.org/10.1109/5.949485

\bibitem{dawkins1986blind} Dawkins, R. (1986). The Blind Watchmaker. W. W. Norton \& Company.

\bibitem{goldberg1989genetic} Goldberg, D. E. (1989). Genetic algorithms in search, optimization, and machine learning. Addison-Wesley.

\bibitem{branke2002evolutionary} Branke, J. (2002). Evolutionary optimization in dynamic environments. Springer Science \& Business Media.

\bibitem{mccormack2013computers} McCormack, J., \& d'Inverno, M. (Eds.). (2013). Computers and creativity. Springer Science \& Business Media.

\bibitem{roberts2018hierarchical} Roberts, A., Engel, J., Raffel, C., Hawthorne, C.,\& Eck, D. (2018). A hierarchical latent vector model for learning long-term structure in music. In Proceedings of the 35th International Conference on Machine Learning (pp. 4364-4373). PMLR.

\bibitem{dong2018musegan} Dong, H. W., Hsiao, W. Y., Yang, L. C., \& Yang, Y. H. (2018). MuseGAN: Multi-track sequential generative adversarial networks for symbolic music generation and accompaniment. In Proceedings of the AAAI Conference on Artificial Intelligence (Vol. 32, No. 1).

\bibitem{huang2018music} Huang, C. Z. A., Vaswani, A., Uszkoreit, J., Shazeer, N., Simon, I., Hawthorne, C., ... \& Eck, D. (2018). Music transformer: Generating music with long-term structure. arXiv preprint arXiv:1809.04281.

\bibitem{yang2017midinet} Yang, L. C., Chou, S. Y., \& Yang, Y. H. (2017). MidiNet: A convolutional generative adversarial network for symbolic-domain music generation. In Proceedings of the 18th International Society for Music Information Retrieval Conference (ISMIR) (pp. 324-331).

\bibitem{herremans2017morpheus} Herremans, D., \& Chew, E. (2017). MorpheuS: Generating structured music with high-level patterns and constraints. IEEE Transactions on Affective Computing, 10(4), 489-502. https://doi.org/10.1109/TAFFC.2017.2695597

\bibitem{lippit2021computational} Lippi, M., \& d'Inverno, M. (2021). Computational creativity: The role of the human in the loop. Journal of Artificial Intelligence Research, 71, 1-25.

\bibitem{pachet2021learning} Pachet, F. (2021). Learning and controlling musical style. Nature Reviews Physics, 3(6), 384-385.

\bibitem{ji2020comprehensive} Ji, S., Luo, J., \& Yang, X. (2020). A comprehensive survey on deep music generation: Multi-level representations, algorithms, and datasets. arXiv preprint arXiv:2006.06293.
